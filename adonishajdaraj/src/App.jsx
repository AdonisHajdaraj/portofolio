...
const cvData = {
  personal: {
    ...
    title: 'Bsc.Computer Science | Full-Stack Developer | AI/ML Enthusiast',
    ...
    about: 'Full-Stack Developer with strong experience in building scalable web applications using React, Node.js, and modern backend technologies. Skilled in designing secure APIs, implementing authentication systems (JWT), and working with both SQL and NoSQL databases. Passionate about continuous learning, currently expanding knowledge in Python, AI, and Machine Learning. Focused on delivering clean, efficient, and real-world solutions.'
  },
  education: [
    {
  ...
  skills: {
    frontend: ['React.js', 'Next.js', 'JavaScript', 'HTML', 'CSS', 'Bootstrap'],
    backend: ['Node.js', 'Express', 'Python', 'FastAPI', 'Django', 'PHP'],
  ...
  experience: [
    {
      ...
      period: '2024',
      description: 'Worked on real-world full-stack applications using React and Node.js, improving code structure, API development, and database integration.',
      achievements: []
    },
    {
      ...
      period: '2022 - Present',
      description: 'Developed and deployed multiple web applications for different use cases including management systems and e-commerce platforms.',
      achievements: [
        'Built a Hotel Management System with booking and admin dashboard',
        'Developed a full E-commerce platform with authentication and payments',
        'Created a Job Portal with filtering and role-based access',
        'Designed RESTful APIs and optimized database structures'
      ]
    }
  ],
  projects: [],
  certifications: [
    'Java & Spring Boot – Probit Academy',
    'Full Stack Development – Arra Academy',
    'React.js Development – Techtion Academy',
        ...
        <div className="cv-left-column">
          ...
          <div className="cv-section">
            ...
            <div className="cv-skill-line">
              ...
              <span className="cv-skill-items">{cvData.skills.frontend.join(', ')}</span>
            </div>
            <div className="cv-skill-line">
              <span className="cv-skill-cat">Backend:</span>
              <span className="cv-skill-items">{cvData.skills.backend.join(', ')}</span>
            </div>
            <div className="cv-skill-line">
              <span className="cv-skill-cat">Databases:</span>
              <span className="cv-skill-items">{cvData.skills.databases.join(', ')}</span>
            </div>
            <div className="cv-skill-line">
              <span className="cv-skill-cat">AI/ML:</span>
              <span className="cv-skill-items">{cvData.skills.ai_ml.join(', ')}</span>
            </div>
            <div className="cv-skill-line">
              <span className="cv-skill-cat">Tools:</span>
              <span className="cv-skill-items">{cvData.skills.tools.join(', ')}</span>
            </div>
          </div>
          ...
          <div className="cv-section">
            ...
            {cvData.education.map((edu, idx) => (
              <div key={idx} className="cv-edu-item">
                ...
                <p className="cv-edu-period">{edu.period}</p>
              </div>
            ))}
          </div>
          ...
          <div className="cv-section">
            ...
            {cvData.languages.map((lang, idx) => (
              <p key={idx} className="cv-language">{lang}</p>
            ))}
          </div>
        </div>
        ...
        <div className="cv-right-column">
          ...
          <div className="cv-section">
            ...
            {cvData.experience.map((exp, idx) => (
              <div key={idx} className="cv-exp-item">
                ...
                <p className="cv-exp-period">{exp.period}</p>
          ...
          <div className="cv-section">
            ...
            {cvData.certifications.map((cert, idx) => (
              <p key={idx} className="cv-cert-line">{cert}</p>
            ))}
          </div>
        </div>
      </div>
...
function App() {
        ...
        <head>
          ...
          <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .cv-edu-period { font-size: 0.7rem; color: #94a3b8; margin-top: 2px; }
            .cv-language { font-size: 0.78rem; color: #475569; margin-bottom: 4px; }
            .cv-about-text { font-size: 0.82rem; color: #475569; line-height: 1.5; text-align: justify; }
            .cv-exp-item { margin-bottom: 12px; }
            .cv-exp-title { font-weight: 600; font-size: 0.85rem; color: #1e293b; margin-bottom: 2px; }
            .cv-exp-period { font-size: 0.7rem; color: #94a3b8; margin-bottom: 4px; }
            ...
            .cv-cert-line { font-size: 0.78rem; color: #475569; margin-bottom: 4px; }
  ...
  const deployedProjects = [
    ...
    },
    {
      id: 'ai-chatbot',
      icon: '🤖',
      title: 'AI Platform Pro | Chatbot • Quiz • Code Analyzer',
      subtitle: 'Full-Stack AI Learning Platform',
      description: 'An advanced AI-powered platform built with Python FastAPI and Groq LLM, featuring an intelligent chatbot, automatic quiz generator with certificate system, code analyzer, and structured learning paths from beginner to senior level.',
      tech: ['Python', 'FastAPI', 'Groq API', 'JavaScript', 'HTML/CSS', 'Responsive Design', 'Vercel'],
      category: 'software',
      image: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&q=80',
      features: [
        'AI Chatbot powered by Groq LLM',
        'Automatic quiz generator with scoring',
        'Certificate system for perfect scores',
        'Code analyzer for Python & JavaScript',
        'Learning paths (Beginner → Senior)',
        'Responsive mobile-first design'
      ],
      liveUrl: 'https://chatbot-python-bay.vercel.app/'
    }
  ];

  // Private/Main projects
  const mainProjects = [
    {
      id: 'hotel', 
      icon: '🏨', 
  ...
  // Python & AI Projects
  const pythonAiProjects = [
    {
      id: 'ai-image-recognition',
      icon: '🧠',
      title: 'AI Image Recognition System',
      subtitle: 'Deep Learning Computer Vision Project',
      description: 'A state-of-the-art image recognition system built with TensorFlow and Keras. This project implements a Convolutional Neural Network (CNN) capable of identifying and classifying objects in images with high accuracy. Trained on custom datasets for specific use cases.',
      tech: ['Python', 'TensorFlow', 'Keras', 'NumPy', 'Pandas', 'OpenCV', 'Matplotlib'],
      category: 'python-ai',
      ...
      features: [
        ...
        'Transfer learning implementation with ResNet50',
        'Data augmentation for improved generalization'
      ],
      isDeployed: false,
      githubLink: 'https://github.com/AdonisHajdaraj/ai-image-recognition'
    },
    {
      id: 'smart-data-analysis',
      icon: '📊',
      title: 'Smart Data Analysis Platform',
      subtitle: 'Machine Learning & Predictive Analytics',
      description: 'An intelligent data analysis platform that leverages machine learning algorithms to extract insights, predict trends, and automate decision-making. Built with Scikit-learn, Pandas, and advanced statistical methods for comprehensive data processing.',
      tech: ['Python', 'Scikit-learn', 'Pandas', 'NumPy', 'Seaborn', 'Plotly', 'Jupyter'],
      category: 'python-ai',
      ...
      features: [
        ...
        'Predictive analytics with 88%+ accuracy',
        'Anomaly detection system',
        'Automated report generation (PDF/Excel)'
      ],
      isDeployed: false,
      githubLink: 'https://github.com/AdonisHajdaraj/smart-data-analysis'
    }
  ];

  // Të gjitha projektet
  const allProjects = [...deployedProjects, ...mainProjects, ...pythonAiProjects];

  const getFilteredProjects = () => {
    if (projectCategory === 'all') return allProjects;
    if (projectCategory === 'software') return [...deployedProjects, ...mainProjects];
    if (projectCategory === 'python-ai') return pythonAiProjects;
    return allProjects;
  };
  ...
  const certificates = [
    ...
    { icon: '🐍', title: 'Python for Data Science & AI', org: 'IBM / Coursera' },
    { icon: '🤖', title: 'Machine Learning Specialization', org: 'Stanford / DeepLearning.AI' }
  ];

  const skills = [
    { category: 'Frontend', icon: '🎯', items: ['HTML', 'CSS', 'Bootstrap', 'JavaScript', 'React.js', 'Next.js'], color: '#6366f1' },
    { category: 'Backend', icon: '⚙️', items: ['PHP', 'Node.js', 'Java', 'Python', 'Express.js', 'Spring Boot', 'FastAPI', 'REST API'], color: '#06b6d4' },
    { category: 'Database', icon: '🗄️', items: ['MySQL', 'MongoDB', 'PostgreSQL', 'Firebase', 'Redis', 'Prisma ORM'], color: '#8b5cf6' },
    { category: 'AI & Machine Learning', icon: '🧠', items: ['TensorFlow', 'Keras', 'Scikit-learn', 'Pandas', 'NumPy', 'OpenCV', 'Matplotlib', 'Seaborn'], color: '#ec4899' },
    { category: 'CMS & Tools', icon: '🛠️', items: ['WordPress', 'Git', 'Docker', 'AWS', 'Vercel', 'CI/CD', 'Linux', 'Jupyter'], color: '#f59e0b' },
    { category: 'Design', icon: '🎨', items: ['Photoshop', 'Illustrator', 'Figma', 'Canva', 'Adobe XD', 'UI/UX'], color: '#10b981' }
  ];
    ...
    <div className="app-futuristic" ref={mainRef}>
        ...
        <div className="hero-overlay">
          ...
          >
            ...
            >
              ...
              <span className="typing-separator">|</span>
              <span className="typing-text">Python & AI Enthusiast</span>
              <span className="typing-separator">|</span>
              <span className="typing-text">CS Engineer</span>
            </motion.div>
            ...
            <motion.div className="about-content-future reveal-right">
              <div className="glass-panel">
                <p className="about-lead">
                  Passionate <span className="gradient-text">Full-Stack Developer</span> & <span className="gradient-text">Python/AI Enthusiast</span> with a keen eye for design and a drive for innovation.
                </p>
                <p>
                  I am a passionate Full-Stack Developer focused on frontend, backend, and full-stack development, with expanding expertise in Python and Artificial Intelligence. 
                  I have completed my Bachelor's degree in Computer Science at UBT and I am currently pursuing my Master's studies in the same field. 
                  I continuously expand my knowledge in Python, machine learning, and deep learning to build intelligent solutions that solve real-world problems.
                </p>
      ...
      <section id="projects" className="section-future projects-section">
        <div className="container">
          ...
          >
            <button 
              className={`category-btn ${projectCategory === 'all' ? 'active' : ''}`}
              onClick={() => setProjectCategory('all')}
            >
              <span>🌟</span> All Projects
            </button>
            <button 
              className={`category-btn ${projectCategory === 'software' ? 'active' : ''}`}
              onClick={() => setProjectCategory('software')}
            >
              <span>💻</span> Software Development
            </button>
            <button 
              className={`category-btn ${projectCategory === 'python-ai' ? 'active' : ''}`}
              onClick={() => setProjectCategory('python-ai')}
            >
              <span>🧠</span> Python & AI/ML
            </button>
          </motion.div>

          <div key={projectCategory}>
                ...
                <div className="project-layout">
                  ...
                  >
                    ...
                    <div className="project-image-overlay">
                      {project.isDeployed === false || project.category === 'python-ai' ? (
                        <>
                          <span className="overlay-text private-badge">🔬 Research Project</span>
                          <span className="overlay-text deploy-badge">📦 Not Deployed</span>
                          {project.githubLink && (
                            <motion.a 
                  ...
                  <div className="project-content">
                    <div className="showcase-header">
                      ...
                      <div>
                        <h3 className="project-title-glow">
                          {project.title}
                          {project.category === 'python-ai' && (
                            <span className="project-ai-badge">AI/ML</span>
                          )}
                        </h3>
                    ...
                    <div className="project-details">
                      ...
                      <div className="project-status">
                        {project.category === 'python-ai' && (
                          <>
                            <span className="status-badge research-badge">📊 Research & Development</span>
                            <span className="status-badge private-badge">🔬 Academic Project</span>
                          </>
                        )}
                        {project.isDeployed === false && project.category === 'python-ai' && (
                          <span className="status-badge deploy-badge">📦 Private Repository</span>
                        )}
                        {!project.isDeployed && project.category !== 'python-ai' && (
                          <span className="status-badge">🔒 Private Repository</span>
                        )}
                      </div>

                      {project.category === 'python-ai' && project.githubLink && (
      ...
      {/* Certificates Section - ME KEY */}
      <section id="certificates" className="section-future certs-section" key={`certs-${projectCategory}`}>
        <div className="container">
          <motion.h2 className="section-title-future reveal">
      ...
      {/* Contact Section - ME KEY */}
      <section id="contact" className="section-future contact-section" key={`contact-${projectCategory}`}>
        <div className="container">
          <motion.h2 className="section-title-future reveal">
